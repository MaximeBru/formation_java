...
public class Main {
    ...
    private static void emprunterLivre() {
        ...
        Livre livre = new Livre("", "", isbnLivre); // Le titre et l'auteur ne sont pas nécessaires ici
    ...
    private static void chargerDonnees() {
        try {
            bibliotheque.ajouterLivres(Chargement.chargerLivres("livres.txt"));
            bibliotheque.ajouterUtilisateurs(Chargement.chargerUtilisateurs("utilisateurs.txt"));
    ...
    private static void sauvegarderDonnees() {
        try {
            ...
            Sauvegarde.sauvegarderUtilisateurs(bibliotheque.getUtilisateurs(), "utilisateurs.txt");
